 ...
 * @returns {string}
 */
export function run_bench_single(fen, label, depth) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        const ret = wasm.run_bench_single(ptr0, len0, ptr1, len1, depth);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
...
function __wbg_adapter_35(arg0, arg1) {
    const ret = wasm.wasm_bindgen_685480f4cbcdc7a___convert__closures_____invoke___core_ed718c3d60ebd546___result__Result_____wasm_bindgen_685480f4cbcdc7a___JsValue___multivalue_shim(arg0, arg1);
    if (ret[1]) {
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper1077 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 331, __wbg_adapter_38);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('chess_game_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
