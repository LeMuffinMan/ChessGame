...
impl ChessApp {
    ...
    fn central_panel_desktop_body(&mut self, ui: &mut egui::Ui, ctx: &egui::Context) {
    ...
    fn central_panel_mobile_body(&mut self, ui: &mut egui::Ui, ctx: &egui::Context) {
        ...
        ui.vertical(|ui| {
            ui.allocate_ui_with_layout(
                ...
                |ui| {
                    ...
                    self.display_bottom_buttons_mobile(ui);
                },
            );
        });
    }

    fn mobile_board_display(&mut self, ui: &mut egui::Ui, board_size: f32, ctx: &egui::Context) {
