                                    ...
                                    egui::ScrollArea::vertical()
                                        ...
                                        .show(ui, |ui| {
                                            egui::Grid::new("depth_tree").striped(true).show(
                                                ui,
                                                |ui| {
                                                    for depth in 1..self.search_ctx.stats.nodes_per_depth.len()
                                                    {
                                                        ui.label(
                                                            egui::RichText::new(format!(
                                                                "D {}",
                                                        ...
                                                        ui.label(
                                                            egui::RichText::new(format!(
                                                                "{} n",
                                                                self.search_ctx.stats.nodes_per_depth[depth]
                                                            ))
                                                            .small(),
                                                        );
                                                        ui.label(
                                                            egui::RichText::new(format!(
                                                                "{} cut",
                                                                self.search_ctx.stats.cutoffs_per_depth[depth]
                                                            ))
                                                            .small(),
                                                        );
                                                        ui.end_row();
                    ...
                    ui.vertical(|ui| {
                        ui.horizontal(|ui| {
                            ...
                            ui.label(
                                egui::RichText::new(format!(
                                    "Time: {}",
                                    SearchStats::format_time(self.search_ctx.stats.bot_time_thinking)
                                ))
                                .small(),
                            );
                            match color {
                        ...
                        ui.horizontal(|ui| {
                            ui.label(
                                egui::RichText::new(format!("Nodes: {}", self.search_ctx.stats.nodes)).small(),
                            );
                            ui.label(
                                egui::RichText::new(format!("Cutoffs: {}", self.search_ctx.stats.cutoffs))
                                    .small(),
                            );
                            ui.label(
                                egui::RichText::new(format!("NPS: {:.0}", self.search_ctx.stats.nps)).small(),
                            );
                        });
                    });
                }
